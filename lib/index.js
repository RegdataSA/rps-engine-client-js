  ...
  */
  ...
  class TokenProvider {
    ...
    constructor({
      ...
      _classPrivateFieldSet(this, _clientSecret, clientSecret);
    }
    ...
    async generateToken(secrets) {
      ...
      try {
        ...
        const response = await _classPrivateFieldGet(this, _httpClient$1).post(this.authEndpoint, this._data);

        const tokenInfo = this._parseTokenInfo(response === null || response === void 0 ? void 0 : response.data);
  ...
  class EngineClient {
    ...
    async transformPostRequest(requestData, tokenInfo) {
      ...
      return _classPrivateFieldGet(this, _httpClient).post('api/transform', requestData, {
        headers
      });
    }
    /**
    ...
    async transform(requestData, config = {}) {
      ...
      try {
        ...
        return _classPrivateMethodGet(this, _handleErrors, _handleErrors2).call(this, error, requestData, config);
      }
    }

  }

  function _handleErrors2(error, requestData, config) {
    if (error.status === 401 && !_classPrivateFieldGet(this, _secondAttempt)) {
      _classPrivateFieldSet(this, _secondAttempt, true);

      _classPrivateFieldGet(this, _tokenProvider).clearTokenInfo();
  ...
  function _validateClient({
    ...
    const validator = new Validator([{
      ...
      rule: tokenProvider instanceof TokenProvider || !!(authorizationParams !== null && authorizationParams !== void 0 && authorizationParams.identityServerHostName),
  ...
  function _validateReferences(requestData) {
    ...
    const isValid = Array.isArray(requests) && requests.every(({
      processingContext,
      rightsContext
    }) => {
